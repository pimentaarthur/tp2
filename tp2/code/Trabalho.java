...
public class Trabalho {
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\1349019\\Desktop\\tp2\\tp2-main\\tp2\\code\\characters.csv";
    ...
    public static ArrayList<Personagem> leitor(String path) throws IOException {
        ...
        while ((linha = buffRead.readLine()) != null) {
            ...
            try {
                ...
                personagem.setdateOfBirth(formato.format(data));
    ...
    public static class Personagem {
        ...
        String actorName,boolean alive, String dateOfBirth,int yearOfBirth,String eyeColour,String gender,String hairColour,boolean wizard){
